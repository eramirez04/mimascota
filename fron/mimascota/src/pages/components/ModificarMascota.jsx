...
const ModificarMascota = ({ id }) => {
  ...
  useEffect(() => {
    ...
    // ejecutamos las funciones que nos permitiran todas las
              ...
              <li>
                <section className="flex flex-row bg-[url('info-race.svg')] bg-no-repeat h-12 w-80">
                  ...
                  <select
                    ...
                    value={mascota.raza}
                    onChange={(e) =>
                      setMascota({ ...mascota, raza: e.target.value })
                    }
                  >
                    {razas.map((raza) => (
              ...
              <li>
                <section className="flex flex-row bg-[url('info-category.svg')] bg-no-repeat h-12 w-80">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMascota({ ...mascota, categoria: e.target.value })
                    }
                  >
              ...
              <li>
                <section className="flex flex-row bg-[url('info-gender.svg')] bg-no-repeat h-12 w-80">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMascota({ ...mascota, genero: e.target.value })
                    }
                  >
                    {generos.map((genero) => (
